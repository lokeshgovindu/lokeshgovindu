...
<!--
DISABLED: this returns HTTP 404. It reads from an `output` branch that does not
exist, and no workflow in this repo generates the snake SVG. To enable it, add a
Platane/snk workflow that writes github-contribution-grid-snake.svg to a branch
named `output`, then uncomment the line below.
